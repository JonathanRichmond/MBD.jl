...
"""
function canGenerateUpdate(leastSquaresUpdateGenerator::LeastSquaresUpdateGenerator, multipleShooterProblem::MBD.BCR4BP12MultipleShooterProblem)
...
# Arguments
- `leastSquaresUpdateGenerator::LeastSquaresUpdateGenerator`: Least squares update generator object
- `multipleShooterProblem::BCR4BP12MultipleShooterProblem`: BCR4BP P1-P2 multiples shooter problem object
"""
function getFullUpdate(leastSquaresUpdateGenerator::LeastSquaresUpdateGenerator, multipleShooterProblem::MBD.BCR4BP12MultipleShooterProblem)
