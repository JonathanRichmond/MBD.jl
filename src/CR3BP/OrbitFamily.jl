...
function exportData(orbitFamily::CR3BPOrbitFamily, filename::String)
    ...
    eigenvalue1::Vector{Float64} = Vector{Float64}(undef, length(orbitFamily.familyMembers))
    eigenvalue2::Vector{Float64} = Vector{Float64}(undef, length(orbitFamily.familyMembers))
    eigenvalue3::Vector{Float64} = Vector{Float64}(undef, length(orbitFamily.familyMembers))
    eigenvalue4::Vector{Float64} = Vector{Float64}(undef, length(orbitFamily.familyMembers))
    eigenvalue5::Vector{Float64} = Vector{Float64}(undef, length(orbitFamily.familyMembers))
    eigenvalue6::Vector{Float64} = Vector{Float64}(undef, length(orbitFamily.familyMembers))
    ...
    alternateStabilityIndex1::Vector{Float64} = Vector{Float64}(undef, length(orbitFamily.familyMembers))
    alternateStabilityIndex2::Vector{Float64} = Vector{Float64}(undef, length(orbitFamily.familyMembers))
    alternateStabilityIndex3::Vector{Float64} = Vector{Float64}(undef, length(orbitFamily.familyMembers))
