...
function stopCrashes(manifold::BCR4BP12Manifold)
    ...
    crashEvent = DifferentialEquations.VectorContinuousCallback(primaryDistanceCondition, terminateAffectIndex!, 3; direction = 0)
    ...
    for a::Int64 = 14#1:length(manifold.initialConditions)
